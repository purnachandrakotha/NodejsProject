...
// // URL GET + /inventory/monitors/LCM/:tagNumber
// exports.read = async(req, res)=>{
//     const data = await Monitor.findByTagNumber(req.params.tagNumber)
//     res.status(200).json({
//         success:true, 
//         data
//     })
...
// // URL PUT + /inventory/monitors/LCM/:tagNumber
// exports.update = async(req, res)=>{
//     const data = await Monitor.findByTagNumberAndUpdate(req.params.tagNumber, req.body)
//     res.status(202).json({
//         success:true, 
//         data
//     })
